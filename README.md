...
[`docs/sample-live-report.md`](docs/sample-live-report.md) is a real report generated by this tool against an actual Azure subscription (subscription/tenant IDs redacted). It shows live resource discovery, real VM power state (`running` / `deallocated`), and tag-compliance findings pulled straight from Azure — not the local sample data.

![Live resource summary](docs/screenshots/resource-summary-live.png)
